...
public class NoFreezerFridge extends Fridge {
    ...
    public NoFreezerFridge(double price, String description, ArrayList<Float> size, float power, float temperature,int warrantyPeriod, String countryOfOrigin) throws BadSizeException {
