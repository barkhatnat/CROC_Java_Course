...
public class InductionStove implements IKitchenStove {
    ...
    public InductionStove(double price, String description, ArrayList<Float> size, float power, float ovenTemperature) {
        this.price = price;
