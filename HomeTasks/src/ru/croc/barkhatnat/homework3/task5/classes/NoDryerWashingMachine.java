...
public class NoDryerWashingMachine implements IWashingMachine {
    private double price;
    private String description;
    private ArrayList<Float> size;
    private float power;

    public NoDryerWashingMachine(double price, String description, ArrayList<Float> size, float power) {
        this.price = price;
